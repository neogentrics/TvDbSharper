...
namespace TvDbSharper
{
    ...
    public partial class TvDbClient
    {
        ...
        public Task<TvDbApiResponse<EpisodeBaseRecordDto[]>> AllEpisodes(CancellationToken cancellationToken)
        {
            return this.Get<EpisodeBaseRecordDto[]>($"episodes", null, cancellationToken);
        }

        public Task<TvDbApiResponse<EpisodeBaseRecordDto[]>> AllEpisodes()
        {
            return this.AllEpisodes(CancellationToken.None);
        }

        public Task<TvDbApiResponse<EpisodeBaseRecordDto[]>> AllEpisodes(AllEpisodesOptionalParams optionalParameters, CancellationToken cancellationToken)
        {
            return this.Get<EpisodeBaseRecordDto[]>($"episodes", optionalParameters, cancellationToken);
        }

        public Task<TvDbApiResponse<EpisodeBaseRecordDto[]>> AllEpisodes(AllEpisodesOptionalParams optionalParameters)
        {
            return this.AllEpisodes(optionalParameters, CancellationToken.None);
        }
        ...
        public Task<TvDbApiResponse<PeopleBaseRecordDto[]>> AllPeople(CancellationToken cancellationToken)
        {
            return this.Get<PeopleBaseRecordDto[]>($"people", null, cancellationToken);
        }

        public Task<TvDbApiResponse<PeopleBaseRecordDto[]>> AllPeople()
        {
            return this.AllPeople(CancellationToken.None);
        }

        public Task<TvDbApiResponse<PeopleBaseRecordDto[]>> AllPeople(AllPeopleOptionalParams optionalParameters, CancellationToken cancellationToken)
        {
            return this.Get<PeopleBaseRecordDto[]>($"people", optionalParameters, cancellationToken);
        }

        public Task<TvDbApiResponse<PeopleBaseRecordDto[]>> AllPeople(AllPeopleOptionalParams optionalParameters)
        {
            return this.AllPeople(optionalParameters, CancellationToken.None);
        }
        ...
        public Task<TvDbApiResponse<SearchByRemoteIdResultDto[]>> SearchByRemoteId(string remoteId, CancellationToken cancellationToken)
        {
            return this.Get<SearchByRemoteIdResultDto[]>($"search/remoteid/{remoteId}", null, cancellationToken);
        }

        public Task<TvDbApiResponse<SearchByRemoteIdResultDto[]>> SearchByRemoteId(string remoteId)
        {
            return this.SearchByRemoteId(remoteId, CancellationToken.None);
        }
        ...
        public Task<TvDbApiResponse<SeriesBaseRecordDto>> SeriesBySlug(string slug, CancellationToken cancellationToken)
        {
            return this.Get<SeriesBaseRecordDto>($"series/slug/{slug}", null, cancellationToken);
        }

        public Task<TvDbApiResponse<SeriesBaseRecordDto>> SeriesBySlug(string slug)
        {
            return this.SeriesBySlug(slug, CancellationToken.None);
        }
        ...
        public Task<TvDbApiResponse<UserInfoDto>> UserInfo(CancellationToken cancellationToken)
        {
            return this.Get<UserInfoDto>($"user", null, cancellationToken);
        }

        public Task<TvDbApiResponse<UserInfoDto>> UserInfo()
        {
            return this.UserInfo(CancellationToken.None);
        }

        public Task<TvDbApiResponse<UserInfoDto>> UserInfoDto(int id, CancellationToken cancellationToken)
        {
            return this.Get<UserInfoDto>($"user/{id}", null, cancellationToken);
        }

        public Task<TvDbApiResponse<UserInfoDto>> UserInfoDto(int id)
        {
            return this.UserInfoDto(id, CancellationToken.None);
        }
    }
    ...
    public class AllEpisodesOptionalParams
    {
        [QueryParameter("page")]
        public int? Page { get; set; }
    }
    ...
    public class AllPeopleOptionalParams
    {
        [QueryParameter("page")]
        public int? Page { get; set; }
    }
